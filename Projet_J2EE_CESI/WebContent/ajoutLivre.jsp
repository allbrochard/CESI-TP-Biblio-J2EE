	...
	<div class="row">
		<div class="col-md-4 offset-md-4">
			<form method="post" action="InsertLivre">
				...
				<div class="form-group">
					<input type="text" class="form-control" id="edition" name="edition" placeholder="Entrez le nom de l'editeur">
				</div>
				<div class="form-group">
					<input type="auteur" class="form-control" id="auteur" name="auteur" placeholder="Entrez le nom de l'auteur">
				</div>
